...
class RecommendedClashRepositoryTest {
    ...
    void recommendChampionDefaultCase() throws NoDataException {
        ...
        List<RecommendedClashChampionModel> resultSet = recommendedClashRepository.recommendChampion(data);
        Assertions.assertEquals(3, resultSet.size());
        for (int i = 0; i < resultSet.size() ; i++) {
    ...
    void recommendChampionNoDataException() {
        ...
        Assertions.assertThrows(NoDataException.class, () -> recommendedClashRepository.recommendChampion(accounts));
    }
    @Test
    ...
    void championWinNoDataException() {
        ...
        Assertions.assertThrows(NoDataException.class, () -> recommendedClashRepository.championWin(accounts));
    }
}