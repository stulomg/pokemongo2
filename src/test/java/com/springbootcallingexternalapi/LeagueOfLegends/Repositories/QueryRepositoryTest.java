...
class QueryRepositoryTest {
  ...
  void newQueryDefaultCase() throws QueryCriteriaExistException {
    ...
    List<QueryModel> result = jdbcTemplate.query("SELECT * FROM \"SpecificQuery\"",
  ...
  void newQueryQueryCriteriaExistException() throws QueryCriteriaExistException {
    ...
    queryRepository.newQuery(newQuery);
    Assertions.assertThrows(QueryCriteriaExistException.class,
        () -> queryRepository.newQuery(newQuery));
  }

  @Test
  void specificQueryDefaultCase()
      throws QuerySyntaxErrorException, AccountDataException, AccountExistsOrNotException, NoDataException {
  ...
  void specificQuerySyntaxError() {
    ...
    Assertions.assertThrows(QuerySyntaxErrorException.class,
        () -> queryRepository.specificQuery(newQuery));
  }
  ...
  void filterQueryQueryFilterNoDataException() {
    Assertions.assertThrows(QueryFilterNoDataException.class,
        () -> queryRepository.filterQuery("prueba"));
  }
}