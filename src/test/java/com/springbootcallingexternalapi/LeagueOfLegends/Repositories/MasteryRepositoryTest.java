...
public class MasteryRepositoryTest {
  ...
  void insertMasteryInfoSuccessfullyDefaultCase() throws AccountDataException {
    ...
    List<MasteryHistoryInfoModel> resultSet = jdbcTemplate.query("SELECT * FROM \"MasteryHistory\"",
  ...
  void accountDataExceptionInsertMasteryHistory() throws AccountDataException {
    ...
    Exception exception = assertThrows(AccountDataException.class,
        () -> repository.insertMasteryInfo(basemodel));
  ...
  @Test
  void accountMasteryHistorySuccessfullyDefaultCase()
      throws AccountDataException, CharacterNotAllowedException, AccountNotFoundException {
