...
public class MasteryRepository {
  ...
  public List<MasteryHistoryModel> AccountMasteryHistory(String account, Integer accountID)
    ...
    String sql =
        "SELECT (SELECT \"ChampionName\" FROM \"Champion\" WHERE \"ChampionId\" = a.champion) as champion, a.\"championPoints\", a.\"championLevel\", a.date, (SELECT \"name\" FROM \"Account\" WHERE \"id_BD\" = a.account) as account\n"
            +
