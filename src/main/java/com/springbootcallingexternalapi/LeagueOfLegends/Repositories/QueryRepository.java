...
public class QueryRepository {
    ...
    public List<QueryResponseModel> querySpecific(QueryModel queryModel, String sql) throws QuerySyntaxError {
        ...
        try {
            ...
            throw new QuerySyntaxError(queryModel.getCriterio());
        }
        return null;
    }
}
