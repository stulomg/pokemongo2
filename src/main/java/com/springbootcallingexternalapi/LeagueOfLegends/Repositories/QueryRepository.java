...
public class QueryRepository {
    ...
    public List<QueryResponseModel> specificQuery(QueryModel queryModel) throws QuerySyntaxErrorException, NoDataException {
        try {
            List<QueryResponseModel>  querySpecific= jdbcTemplate.query(queryModel.getQuery(),BeanPropertyRowMapper.newInstance(QueryResponseModel.class));
    ...
    public  List<QueryModel> listQuery() throws QueryNoDataException {
        ...
        List<QueryModel>  querySpecific= jdbcTemplate.query(sql,BeanPropertyRowMapper.newInstance(QueryModel.class));
        if (querySpecific.isEmpty()) {
    ...
    public  QueryModel filterQuery(String criteria) throws QueryFilterNoDataException {
        ...
        try {
            QueryModel filterQuery= jdbcTemplate.queryForObject(sql,params, BeanPropertyRowMapper.newInstance(QueryModel.class));
            return filterQuery;
