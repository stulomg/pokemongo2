...
public class MatchRepository {
    ...
    public void insertIndividualMatchData(GameDataModel gamedata, Integer accountID, Integer positionID, Integer championID) {
    ...
    public void insertFullMatchData (CurrentGameInfoBaseModel gameModel) {
        ...
        Object[] params = {gameModel.getMapId(),gameModel.getGameMode(),gameModel.getGameType(), gameModel.getParticipants()};
        jdbcTemplate.update(sql,params);
    }
}