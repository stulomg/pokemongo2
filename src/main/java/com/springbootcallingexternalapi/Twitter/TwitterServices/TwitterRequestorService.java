...
public class TwitterRequestorService {
    ...
    public ResponseEntity<TweetsBigDataModel> getRiotTweets() throws DBNotAvaliableException {
        ...
        ResponseEntity<TweetsBigDataModel> response = requestToTwitterHashtags(uri, HttpMethod.GET, TweetsBigDataModel.class);
    ...
    public <T> ResponseEntity<T> requestToSentimentAnalysis(String uri, HttpMethod method, Class<T> clazz){
